...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=930065637ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mysql&table=columns_priv">`mysql`.`columns_priv`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="376c6e7965656c5873683d75783f5474">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="mysql" targettable="columns_priv">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `columns_priv`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="clevertouchdb" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">create table smartNote(
	notes_id int AUTO_INCREMENT PRIMARY KEY,
    notes_title varchar(100),
    notes_description varchar(10000),
    notes_date_stamp date,
    stud_num int, CONSTRAINT stud_notes FOREIGN KEY (stud_num) REFERENCES Student(stud_num)
);</span>
                        </div>
